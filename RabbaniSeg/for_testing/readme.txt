RabbaniSeg MATLAB Python Package
...
2. Installing the RabbaniSeg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
RabbaniSeg. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the RabbaniSeg Package

The RabbaniSeg package is on your Python path. To import it into a Python script or 
session, execute:
